        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-4 lg:col-span-5 flex flex-col items-start">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-pink-100 flex items-center justify-center text-[#ff4f8b] hover:bg-[#ff4f8b] hover:text-white transition-all shadow-sm">
