        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          >
            <NavLink
              to="/about"
              className={({ isActive }) =>
                `flex items-center gap-1.5 px-4 py-2 rounded-lg text-base font-semibold transition-all duration-200 ${
                  isActive || aboutOpen ? 'text-[#2D3436] nav-active-bright' : 'text-[#2D3436]/60 hover:text-[#2D3436] hover:bg-[#F0E6F6]/50'
                }`
              }
            >
              About Us
              <svg className={`w-4 h-4 transition-transform duration-200 ${aboutOpen ? 'rotate-180' : ''} text-current`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
