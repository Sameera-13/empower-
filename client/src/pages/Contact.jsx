          ...
          <div className="lg:col-span-1 space-y-5">
            ...
            <div className="bg-white/80 backdrop-blur-md border border-white/50 shadow-sm rounded-2xl p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.instagram.com/empowerstop?igsh=dzNteXR0bW1vNjFz" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#F0E6F6] flex items-center justify-center text-[#2D3436]/50 hover:bg-[#FF6B9D]/15 hover:text-[#FF6B9D] transition-colors" aria-label="Instagram">
